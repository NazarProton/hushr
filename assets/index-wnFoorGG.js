import{u as g,w,v as m,y as f,i as v,a as b,x}from"./index-CbqjSu7D.js";import{r as u,c as h}from"./if-defined-Buyck8et.js";const e=g({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),y={state:e,subscribe(o){return m(e,()=>o(e))},subscribeKey(o,t){return f(e,o,t)},showTooltip({message:o,triggerRect:t,variant:i}){e.open=!0,e.message=o,e.triggerRect=t,e.variant=i},hide(){e.open=!1,e.message="",e.triggerRect={width:0,height:0,top:0,left:0}}},s=w(y),R=v`
  :host {
    pointer-events: none;
  }
