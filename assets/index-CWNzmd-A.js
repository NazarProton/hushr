import{i as N,a as k,x as a,r as L,e as v,I as p,d as O,R as Y,f as V,A as z,W as E,O as W}from"./index-Bt-ZtiTb.js";import{n as l,c as _,o as j,r as b}from"./if-defined-cjWhgXqM.js";import{T as A,D as F}from"./index-VqhE6jEI.js";import"./index-B2qh-INP.js";import"./index-B6I2k2ha.js";import"./index-CP4_jHp3.js";var R;(function(s){s.approve="approved",s.bought="bought",s.borrow="borrowed",s.burn="burnt",s.cancel="canceled",s.claim="claimed",s.deploy="deployed",s.deposit="deposited",s.execute="executed",s.mint="minted",s.receive="received",s.repay="repaid",s.send="sent",s.sell="sold",s.stake="staked",s.trade="swapped",s.unstake="unstaked",s.withdraw="withdrawn"})(R||(R={}));const U=N`
  :host > wui-flex {
    display: flex;
