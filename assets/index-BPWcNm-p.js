import{i as N,a as k,x as a,r as L,e as v,I as p,d as O,R as Y,f as V,A as z,W as E,O as W}from"./index-chimEQAY.js";import{n as l,c as _,o as j,r as b}from"./if-defined-DA56cUOR.js";import{T as A,D as F}from"./index-b4q8ymTL.js";import"./index-Dzy05XtO.js";import"./index-BNFheiz9.js";import"./index-DEJfAn3m.js";var R;(function(s){s.approve="approved",s.bought="bought",s.borrow="borrowed",s.burn="burnt",s.cancel="canceled",s.claim="claimed",s.deploy="deployed",s.deposit="deposited",s.execute="executed",s.mint="minted",s.receive="received",s.repay="repaid",s.send="sent",s.sell="sold",s.stake="staked",s.trade="swapped",s.unstake="unstaked",s.withdraw="withdrawn"})(R||(R={}));const U=N`
  :host > wui-flex {
    display: flex;
