import{i as T,a as w,x as c,G as J,H as l,I as N,J as x,A as S,O as j,M as I,e as O,t as Z,f as G,W as H,R as U,d as V,b as M,D as Q,k as ee,S as L,T as te}from"./index-B3M5INTk.js";import{n as d,c as g,o as h,r as u}from"./if-defined-CNCBrbfz.js";import{D as ie,T as re}from"./index-vbltgNtt.js";import"./index-DVwkF7W1.js";import"./index-Cn2yYFSC.js";import"./index-DuUepOx9.js";import"./index-DIE6dObk.js";import{O as z}from"./index-jNK5XUBx.js";import"./index-ovkLlOKh.js";import"./index-DFABA9gw.js";import"./index-C93sr27f.js";import"./index-BXuEowd9.js";import"./index-BP4k_As4.js";import"./index-BbM2oogD.js";import"./ref-DW1BHlFa.js";import"./ConstantsUtil-Dmg8YACJ.js";const oe=T`
  :host {
    width: 100%;
  }
...
`;var W=function(a,e,t,r){var o=arguments.length,i=o<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,e,t,r);else for(var n=a.length-1;n>=0;n--)(s=a[n])&&(i=(o<3?s(i):o>3?s(e,t,i):s(e,t))||i);return o>3&&i&&Object.defineProperty(e,t,i),i};const ne=7;let A=class extends w{constructor(){super(),this.unsubscribe=[],this.selectedOnRampProvider=l.state.selectedProvider,this.loading=!1,this.coinbaseTransactions=N.state.coinbaseTransactions,this.tokenImages=x.state.tokenImages,this.unsubscribe.push(l.subscribeKey("selectedProvider",e=>{this.selectedOnRampProvider=e}),x.subscribeKey("tokenImages",e=>this.tokenImages=e),()=>{clearTimeout(this.refetchTimeout)},N.subscribe(e=>{this.coinbaseTransactions={...e.coinbaseTransactions}})),N.clearCursor(),this.fetchTransactions()}render(){return c`
...
`;var B=function(a,e,t,r){var o=arguments.length,i=o<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,e,t,r);else for(var n=a.length-1;n>=0;n--)(s=a[n])&&(i=(o<3?s(i):o>3?s(e,t,i):s(e,t))||i);return o>3&&i&&Object.defineProperty(e,t,i),i};let P=class extends w{constructor(){super(),this.unsubscribe=[],this.selectedCurrency=l.state.paymentCurrency,this.currencies=l.state.paymentCurrencies,this.currencyImages=x.state.currencyImages,this.checked=z.state.isLegalCheckboxChecked,this.unsubscribe.push(l.subscribe(e=>{this.selectedCurrency=e.paymentCurrency,this.currencies=e.paymentCurrencies}),x.subscribeKey("currencyImages",e=>this.currencyImages=e),z.subscribeKey("isLegalCheckboxChecked",e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var n;const{termsConditionsUrl:e,privacyPolicyUrl:t}=j.state,r=(n=j.state.features)==null?void 0:n.legalCheckbox,s=!!(e||t)&&!!r&&!this.checked;return c`
    ...
    `}currenciesTemplate(e=!1){return this.currencies.map(t=>{var r;return c`
      ...
      `})}selectCurrency(e){e&&(l.setPaymentCurrency(e),I.close())}};P.styles=ae;B([u()],P.prototype,"selectedCurrency",void 0);B([u()],P.prototype,"currencies",void 0);B([u()],P.prototype,"currencyImages",void 0);B([u()],P.prototype,"checked",void 0);P=B([g("w3m-onramp-fiat-select-view")],P);const ce=T`
  button {
    padding: var(--wui-spacing-s);
    border-radius: var(--wui-border-radius-xs);
    border: none;
