import{i as N,a as k,x as a,r as L,e as v,I as p,d as O,R as Y,f as V,A as z,W as E,O as W}from"./index-DNZnqGnT.js";import{n as l,c as _,o as j,r as b}from"./if-defined-BxgJ8zDi.js";import{T as A,D as F}from"./index-COw9lev8.js";import"./index-Lz4AI9Ij.js";import"./index-CXFarzoe.js";import"./index-Blq9XW0E.js";var R;(function(s){s.approve="approved",s.bought="bought",s.borrow="borrowed",s.burn="burnt",s.cancel="canceled",s.claim="claimed",s.deploy="deployed",s.deposit="deposited",s.execute="executed",s.mint="minted",s.receive="received",s.repay="repaid",s.send="sent",s.sell="sold",s.stake="staked",s.trade="swapped",s.unstake="unstaked",s.withdraw="withdrawn"})(R||(R={}));const U=N`
  :host > wui-flex {
    display: flex;
